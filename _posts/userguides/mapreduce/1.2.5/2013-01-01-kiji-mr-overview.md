...
[`KijiProducer`]({{site.api_mr_1_2_5}}/produce/KijiProducer.html)). It is typically up to the
...
[`KijiProducer`]({{site.api_mr_1_2_5}}/produce/KijiProducer.html)'s `produce()` and
...
[`KijiProduceJobBuilder`]({{site.api_mr_1_2_5}}/produce/KijiProduceJobBuilder.html)) that make
...
* You will also need a dependency on KijiSchema. See [the KijiSchema
  documentation]({{site.userguide_schema_1_3_7}}/kiji-schema-overview/) for this information.
